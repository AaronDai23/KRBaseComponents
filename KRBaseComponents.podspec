#
#  Be sure to run `pod spec lint KRBaseComponents.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  基础组件,用来放置基类,比如base vc, base mode, base view
                   DESC

  spec.homepage     = "https://github.com/AaronDai23/KRBaseComponents.git"
  ...
  spec.license      = "MIT (KRBaseComponents)"
  ...
  spec.source       = { :git => "https://github.com/AaronDai23/KRBaseComponents.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'Models' do |model|
  model.source_files = "KRBaseComponents/Base/Models/**/*"
  end
